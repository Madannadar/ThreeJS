...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' madanak0509@gmail.com');
    setHasCopied(true);
          ...
          <div className="grid-container">
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
              <Globe
                ...
                labelsData={[{ lat: 19.07, lng: 72.87,
                     text: 'I am here.', 
                     color: 'white', 
                     size: 15 
                }]}
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">madanak0509@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
